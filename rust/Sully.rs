...
fn main() {
	let	i: u32 = 5;
    if i != 0 {
        let file_name: String = format!("Sully_{0}.rs", (i - 1));
        let executable_name: String = format!("Sully_{0}", (i - 1));
